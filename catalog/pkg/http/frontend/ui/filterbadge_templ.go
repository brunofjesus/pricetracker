...
func FilterBadgeComponent(label string, value string, target string) templ.Component {
    ...
    `
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/http/frontend/ui/filterbadge.templ`, Line: 27, Col: 21}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/http/frontend/ui/filterbadge.templ`, Line: 28, Col: 20}
		}
